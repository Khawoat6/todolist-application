...
export default class Edit_Completed extends Component {
...
addText=async()=>{
   ...
   await  database.UpdateMessageToday(this.state.email,Message,(()=>{this.props.navigation.navigate("Completed");}),this.addMessageFail)
