...
export default class Edit_Upcoming extends Component {
...
addText=async()=>{
   ...
   await  database.UpdateMessageToday(this.state.email,Message,(()=>{this.props.navigation.navigate("Upcoming");}),this.addMessageFail)
