...
export default class Edit_Today extends Component {
...
addText=async()=>{
   ...
   await  database.UpdateMessageToday(this.state.email,Message,(()=>{this.props.navigation.navigate("Today");}),this.addMessageFail)
