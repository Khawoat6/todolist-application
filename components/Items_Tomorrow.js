...
export default class Items_Tomorrow extends React.Component {
  state = {
    items: [],
    email: '',
    message: '',
  ...
  update() {
    database.readMessage(this.state.email, this.state.Tomorrow, this.get_text_success, this.get_text_fail);
  ...
  render() {
    ...
    if (items === null || items.length === 0) {
      ...
      <Text style={{ color: '#666666' , marginTop:10, textAlign:'center' }}>You’re all done for tomorrow! #TodoblackZero{'\n'}Enjoy your night.</Text>
  </View> );
    }
